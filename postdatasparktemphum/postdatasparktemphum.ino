...
// // Serial.print(dht_dat[3], DEC);
 ...
 // Serial.println(" C  ");
  ...
  //////////////////
//////////////////
////Alarma del relay aca se cambia la hora
/////////////////
...
// void dream()
// {
// if (client.connect("antofalinux.cl/depto/",80)) { // REPLACE WITH YOUR SERVER ADDRESS
// 		client.println("POST /add.php HTTP/1.1"); 
// 		client.println("Host: antofalinux.cl/depto"); // SERVER ADDRESS HERE TOO
