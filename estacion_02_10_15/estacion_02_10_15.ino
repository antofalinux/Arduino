...
//variable del comando para enviar datos por esp8266
 String cmd;
  String cmd_1;
...
// cmd +="http://rtupdate.wunderground.com/weatherstation/updateweatherstation.php?ID=IREGINDE61&PASSWORD=vIcente25&dateutc=";
  cmd =")";
  cmd_1 +="winddir(";
  cmd_1 +=winddir;
  cmd_1 +=")";
  ...
  cmd +="&windgustdir=";
  cmd +=windgustdir;
  cmd +="&windspdmph_avg2m=";
  cmd +=windspdmph_avg2m, 1;
  cmd +="&winddir_avg2m=";
  cmd +=winddir_avg2m;
  cmd +="&windgustmph_10m=";
  cmd +=windgustmph_10m, 1;
  cmd +="&windgustdir_10m=";
  cmd +=windgustdir_10m;
  cmd +="&humidity=";
  cmd +=humidity, 1;
  ...
  cmd +="&dailyrainin=";
  cmd +=dailyrainin, 2;
  cmd +="&baromin="; //Don't print pressure= because the agent will be doing calcs on the number
  cmd +=presion, 2;
  cmd +="&batt_lvl=";
  cmd +=batt_lvl, 2;
  cmd +="&light_lvl=";
