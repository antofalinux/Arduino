...
int ledPin = 13;
int val;
int hot=1;  //variable de inicio, solo es 1 al arrancar el Arduino, y espera 30 segundos

const int buttonPin0 = 4;
const int buttonPin50 = 3;
const int buttonPin100 = 2;
...
///////////////////////
  ...
  if(hot == 1){
    ...
    seteo();
      ...
      delay(100);  // Espera 3 segundos para que la PTC caldee el cuarzo. NOTA: en vez de tiempo podria
 ...
 //   loop();      // ejecuta la transmision de la baliza  
...
void seteo() 
{
  ...
  delay(1500);
  lcd.setCursor(0, 0);
  lcd.print("  Presiona Menu .");
  lcd.setCursor(0, 1);
  lcd.print("  Para Setear Frecuencia");
  lcd.setCursor(0, 2);
...
int reading = digitalRead(buttonPin);
 ...
 int reading50 = digitalRead(buttonPin50);
    if (reading50 == HIGH)
    {
      lcd.setCursor(0, 0);
  lcd.print("Tono: ");    
  ...
  int reading100 = digitalRead(buttonPin100);
    if (reading100 == HIGH)
    {
       lcd.setCursor(0, 0);
  lcd.print("Tono: ");    
