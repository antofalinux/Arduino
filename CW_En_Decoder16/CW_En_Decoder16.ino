///////////////////////////////////////////////////////////////////////
// CW Decoder made by Hjalmar Skovholm Hansen OZ1JHM  VER 1.1       //
...
pinMode(ende, INPUT);  //determina el dpin 11 para codificar o decoficar
pinMode(ledon, OUTPUT);  //determina el dpin 9 para codificar o decoficar
...
///////////////
 ...
 ende = digitalRead (6);  // comprueba el valor del indicador de tension en el pin

if(ende==HIGH){      //comprueba que el pin que monitoriza la tension de red este en valor alto (hay tension de red)
  Serial.println("ENERGIZADO CODIFICADOR");
  digitalWrite(ledon, HIGH);   // activa el rele de alimentacion del transmisor 
  
  codifica();      // Se Cambia a modo codificador
